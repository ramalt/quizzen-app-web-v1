...
import { Box, CardMedia, Checkbox, Chip, Skeleton, Stack } from "@mui/material";
...
const QuestionDetail = () => {
  ...
  return !isLoading ? (
    ...
    <Box flex={4} p={1}>
      <Card
        sx={{ textDecoration: "none", margin: "5px", marginBottom: "2rem" }}
      >
        <CardHeader
          avatar={
            <Avatar
        ...
        <Box sx={{ textDecoration: "none" }}>
          ...
          <Stack direction={"row"} gap={1} margin={1}>
            <Chip label={"#" + post.tags.exam} size="small" color="warning" />
            <Chip
